...
/// Modal bottom sheet implementing the two-step log-session allocation flow:
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Time block saved successfully!'),
            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(
                      _step == 0 ? 'Log Session: Select' : 'Log Session: Allocate',
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: _isSubmitting
                          ...
                          : Text('Save Session ($_totalPercentage%)'),
                    ),
                  ),
                ],
              ),
